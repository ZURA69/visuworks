...
export default function DatenschutzPage() {
  // CMS Bindungen
  const label = useEditable('datenschutz.label', 'Rechtliches');
  const title = useEditable('datenschutz.title', 'Datenschutzerklärung');
  const tocLabel = useEditable('datenschutz.tocLabel', 'Inhaltsverzeichnis');
  const stand = useEditable('datenschutz.stand', 'Stand: März 2026');
  const weitereTexte = useEditable('datenschutz.weitereTexte', 'Weitere Rechtstexte:');
          ...
          >
            ...
            <div className="space-y-12 text-[15px] leading-relaxed">
              ...
              <section id="verantwortlicher">
                ...
                <div className="text-[#1A1A1A]/70 mb-3 pl-4 border-l-2 border-black/[0.07]">
                ...
                <p className="text-[#1A1A1A]/70">
                  Sollte ein externer Datenschutzbeauftragter bestellt sein, finden Sie dessen Kontaktdaten im <Link to="/impressum" className="text-[#1A1A1A] hover:text-[#9A9A9A] transition-colors underline underline-offset-2">Impressum</Link>.
                </p>
              </section>
              ...
              <section id="hosting">
                ...
                <h3 className="text-base font-semibold text-[#1A1A1A] mb-3">2.1 Hosting</h3>
                <p className="text-[#1A1A1A]/70 mb-3">
                ...
                <h3 className="text-base font-semibold text-[#1A1A1A] mb-3 mt-6">2.2 Server-Logfiles</h3>
                <p className="text-[#1A1A1A]/70 mb-3">
              ...
              <section id="rechtsgrundlagen">
                ...
                <div className="space-y-3">
                  <div className="p-4 rounded-xl bg-black/[0.02] border border-black/[0.07]">
                    <p className="text-[#1A1A1A] font-medium mb-1">Art. 6 Abs. 1 lit. a DSGVO — Einwilligung</p>
                    <p className="text-[#6B6B6B] text-sm">Verarbeitung erfolgt mit ausdrücklicher Einwilligung (z.B. Cookie-Consent für Analytics und Ads). Die Einwilligung kann jederzeit widerrufen werden.</p>
                  </div>
                  <div className="p-4 rounded-xl bg-black/[0.02] border border-black/[0.07]">
                    <p className="text-[#1A1A1A] font-medium mb-1">Art. 6 Abs. 1 lit. b DSGVO — Vertragserfüllung</p>
                    <p className="text-[#6B6B6B] text-sm">Verarbeitung ist zur Erfüllung eines Vertrags oder zur Durchführung vorvertraglicher Maßnahmen erforderlich (z.B. Kontaktanfrage, Auftragsabwicklung).</p>
                  </div>
                  <div className="p-4 rounded-xl bg-black/[0.02] border border-black/[0.07]">
                    <p className="text-[#1A1A1A] font-medium mb-1">Art. 6 Abs. 1 lit. c DSGVO — Rechtliche Verpflichtung</p>
                    <p className="text-[#6B6B6B] text-sm">Verarbeitung ist zur Erfüllung einer rechtlichen Verpflichtung erforderlich (z.B. steuerliche Aufbewahrungspflichten).</p>
                  </div>
                  <div className="p-4 rounded-xl bg-black/[0.02] border border-black/[0.07]">
                    <p className="text-[#1A1A1A] font-medium mb-1">Art. 6 Abs. 1 lit. f DSGVO — Berechtigtes Interesse</p>
                    <p className="text-[#6B6B6B] text-sm">Verarbeitung ist zur Wahrung berechtigter Interessen erforderlich (z.B. Server-Logfiles, Spam-Schutz, IT-Sicherheit).</p>
                  </div>
                </div>
              </section>
              ...
              <section id="cookies">
                ...
                <h3 className="text-base font-semibold text-[#1A1A1A] mb-3 mt-6">6.1 Technisch notwendige Cookies</h3>
                <p className="text-[#1A1A1A]/70 mb-3">
                ...
                <h3 className="text-base font-semibold text-[#1A1A1A] mb-3 mt-6">6.2 Analyse- und Marketing-Cookies</h3>
                <p className="text-[#1A1A1A]/70 mb-3">
              ...
              <section id="analytics">
                ...
                <h3 className="text-base font-semibold text-[#1A1A1A] mb-3 mt-6">7.1 IP-Anonymisierung</h3>
                <p className="text-[#1A1A1A]/70 mb-3">
                ...
                <h3 className="text-base font-semibold text-[#1A1A1A] mb-3 mt-6">7.2 Zweck und Rechtsgrundlage</h3>
                <p className="text-[#1A1A1A]/70 mb-3">
                ...
                <h3 className="text-base font-semibold text-[#1A1A1A] mb-3 mt-6">7.3 Speicherdauer</h3>
                <p className="text-[#1A1A1A]/70">
                  Die von Google Analytics gesetzten Cookies werden nach maximal 14 Monaten automatisch gelöscht. Die Löschung von Daten, deren Aufbewahrungsfrist erreicht ist, erfolgt automatisch einmal im Monat. Weitere Informationen: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#1A1A1A] hover:text-[#9A9A9A] transition-colors underline underline-offset-2">Google Datenschutzerklärung</a>.
                </p>
              </section>
              ...
              <section id="google-ads">
                ...
                <p className="text-[#1A1A1A]/70">
                  Weitere Informationen zum Datenschutz bei Google finden Sie unter: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#1A1A1A] hover:text-[#9A9A9A] transition-colors underline underline-offset-2">https://policies.google.com/privacy</a>.
                </p>
              </section>
              ...
              <section id="speicherdauer">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-[#1A1A1A]/70 border-collapse mt-3">
                    <thead>
                      <tr className="border-b border-black/[0.07]">
                        <th className="text-left py-3 pr-4 font-semibold text-[#1A1A1A]">Datenkategorie</th>
                        <th className="text-left py-3 font-semibold text-[#1A1A1A]">Speicherdauer</th>
                      </tr>
                    </thead>
              ...
              <section id="betroffenenrechte">
                ...
                <div className="space-y-3">
                  <div className="p-4 rounded-xl bg-black/[0.02] border border-black/[0.07]">
                    <p className="text-[#1A1A1A] font-medium mb-1">Auskunftsrecht (Art. 15 DSGVO)</p>
                    <p className="text-[#6B6B6B] text-sm">Sie haben das Recht, eine Bestätigung darüber zu verlangen, ob Sie betreffende personenbezogene Daten verarbeitet werden, und Auskunft über diese Daten zu erhalten.</p>
                  </div>
                  <div className="p-4 rounded-xl bg-black/[0.02] border border-black/[0.07]">
                    <p className="text-[#1A1A1A] font-medium mb-1">Recht auf Berichtigung (Art. 16 DSGVO)</p>
                    <p className="text-[#6B6B6B] text-sm">Sie haben das Recht, die Berichtigung unrichtiger oder die Vervollständigung unvollständiger personenbezogener Daten zu verlangen.</p>
                  </div>
                  <div className="p-4 rounded-xl bg-black/[0.02] border border-black/[0.07]">
                    <p className="text-[#1A1A1A] font-medium mb-1">Recht auf Löschung (Art. 17 DSGVO)</p>
                    <p className="text-[#6B6B6B] text-sm">Sie haben das Recht, die Löschung Ihrer personenbezogenen Daten zu verlangen, sofern die Voraussetzungen des Art. 17 DSGVO erfüllt sind.</p>
                  </div>
                  <div className="p-4 rounded-xl bg-black/[0.02] border border-black/[0.07]">
                    <p className="text-[#1A1A1A] font-medium mb-1">Recht auf Einschränkung (Art. 18 DSGVO)</p>
                    <p className="text-[#6B6B6B] text-sm">Sie haben das Recht, unter bestimmten Voraussetzungen die Einschränkung der Verarbeitung Ihrer Daten zu verlangen.</p>
                  </div>
                  <div className="p-4 rounded-xl bg-black/[0.02] border border-black/[0.07]">
                    <p className="text-[#1A1A1A] font-medium mb-1">Recht auf Datenübertragbarkeit (Art. 20 DSGVO)</p>
                    <p className="text-[#6B6B6B] text-sm">Sie haben das Recht, Ihre Daten in einem strukturierten, gängigen und maschinenlesbaren Format zu erhalten oder die Übermittlung an einen anderen Verantwortlichen zu verlangen.</p>
                  </div>
                  <div className="p-4 rounded-xl bg-black/[0.02] border border-black/[0.07]">
                    <p className="text-[#1A1A1A] font-medium mb-1">Widerspruchsrecht (Art. 21 DSGVO)</p>
                    <p className="text-[#6B6B6B] text-sm">Sie haben das Recht, aus Gründen, die sich aus Ihrer besonderen Situation ergeben, jederzeit gegen die Verarbeitung Sie betreffender personenbezogener Daten Widerspruch einzulegen, sofern die Verarbeitung auf Art. 6 Abs. 1 lit. e oder f DSGVO beruht.</p>
                  </div>
                  <div className="p-4 rounded-xl bg-black/[0.02] border border-black/[0.07]">
                    <p className="text-[#1A1A1A] font-medium mb-1">Widerrufsrecht (Art. 7 Abs. 3 DSGVO)</p>
                    <p className="text-[#6B6B6B] text-sm">Soweit die Verarbeitung auf Ihrer Einwilligung beruht, können Sie diese jederzeit mit Wirkung für die Zukunft widerrufen. Die Rechtmäßigkeit der bis zum Widerruf erfolgten Verarbeitung bleibt unberührt.</p>
                  </div>
                </div>
                <p className="text-[#1A1A1A]/70 mt-4">
                  Zur Ausübung Ihrer Rechte wenden Sie sich bitte an: <a href="mailto:datenschutz@visuworks.de" className="text-[#1A1A1A] hover:text-[#9A9A9A] transition-colors underline underline-offset-2">datenschutz@visuworks.de</a>
                </p>
              </section>
              ...
              <section id="beschwerderecht">
                ...
                <p className="text-[#1A1A1A]/70">
                  ...
                  Website: <a href="https://www.ldi.nrw.de" target="_blank" rel="noopener noreferrer" className="text-[#1A1A1A] hover:text-[#9A9A9A] transition-colors underline underline-offset-2">www.ldi.nrw.de</a>
                </p>
              </section>
              ...
              <section id="drittland">
                ...
                <h3 className="text-base font-semibold text-[#1A1A1A] mb-3 mt-6">13.1 Angemessenheitsbeschluss / EU-U.S. Data Privacy Framework</h3>
                <p className="text-[#1A1A1A]/70 mb-3">
                ...
                <h3 className="text-base font-semibold text-[#1A1A1A] mb-3 mt-6">13.2 Standardvertragsklauseln (SCC)</h3>
                <p className="text-[#1A1A1A]/70 mb-3">
