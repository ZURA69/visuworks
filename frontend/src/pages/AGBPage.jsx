        ...
        <div className="relative max-w-[800px] mx-auto px-6 md:px-12">
          ...
          >
            ...
            <p className="text-base text-white/50 mb-12">
              ...
              Für Unternehmer gelten unsere <Link to="/agb-b2b" className="text-indigo-400 hover:text-indigo-300 transition-colors underline underline-offset-2">AGB für Unternehmer (B2B)</Link>.
            </p>
            ...
            <div className="space-y-12 text-[15px] leading-relaxed">
              ...
              <section id="datenschutz">
                ...
                <p className="text-white/70">
                  (2) Nähere Informationen zur Datenverarbeitung entnehmen Sie bitte unserer <Link to="/datenschutz" className="text-indigo-400 hover:text-indigo-300 transition-colors underline underline-offset-2">Datenschutzerklärung</Link>.
                </p>
              </section>
              ...
              <section id="rechtswahl">
                ...
                <p className="text-white/70">
                  (4) Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300 transition-colors underline underline-offset-2">https://ec.europa.eu/consumers/odr</a>. Wir sind zur Teilnahme an einem Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle weder verpflichtet noch bereit.
                </p>
              </section>
