        ...
        <div className="relative max-w-[800px] mx-auto px-6 md:px-12">
          ...
          >
            ...
            <p className="text-base text-white/50 mb-12">
              ...
              Für Verbraucher gelten unsere <Link to="/agb" className="text-indigo-400 hover:text-indigo-300 transition-colors underline underline-offset-2">AGB (B2C)</Link>.
            </p>
            ...
            <div className="space-y-12 text-[15px] leading-relaxed">
              ...
              <section id="datenschutz">
                ...
                <p className="text-white/70">
                  (2) Nähere Informationen entnehmen Sie unserer <Link to="/datenschutz" className="text-indigo-400 hover:text-indigo-300 transition-colors underline underline-offset-2">Datenschutzerklärung</Link>.
                </p>
              </section>
