        ...
        <div className="relative max-w-[1200px] mx-auto px-6 md:px-12 py-24 md:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="initial" animate="animate" className="space-y-8">
              ...
              <motion.div variants={fadeInUp}>
                <Link to="/kontakt">
                  <Button data-testid="design-cta" size="lg">
                    Projekt anfragen
      ...
      <section className="py-24 md:py-32 bg-white/[0.02]">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12">
          <motion.div
            ...
            className="mb-16"
          >
            <p className="text-sm font-medium text-white/40 uppercase tracking-wider mb-4">Designprozess</p>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight">Von der Idee zur Umsetzung</h2>
          </motion.div>
