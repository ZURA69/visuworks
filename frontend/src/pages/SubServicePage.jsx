      ...
      <section className="relative py-24 md:py-32">
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 md:px-12">
          ...
          >
            ...
            <span>/</span>
            <Link to={data.parentHref} className="hover:text-white/60 transition-colors">{data.parent}</Link>
            <span>/</span>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <Link
                to={data.parentHref}
                className="inline-flex items-center gap-2 text-sm text-indigo-300/80 hover:text-indigo-300 transition-colors mb-6"
              >
              ...
              <p className="text-base text-white/70 leading-relaxed mb-8">{data.description}</p>
            ...
            >
              {data.features.map((f, i) => (
                <motion.div
                  ...
                  className="p-5 rounded-[18px] bg-white/[0.02] border border-white/10 hover:border-white/20 transition-all duration-300"
                >
      ...
      <section className="py-20 bg-white/[0.02]">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <p className="text-sm font-medium text-white/40 uppercase tracking-wider mb-4">Einsatzbereiche</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {data.applications.map((app, i) => (
              <motion.div
                ...
                className="flex items-center gap-3 p-5 rounded-[16px] bg-white/[0.03] border border-white/10"
              >
